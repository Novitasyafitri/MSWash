...
<div class="container form-wrapper">
    ...
    <h4 class="page-title">
        {{ strtolower($produk->kategori) === 'minuman' ? 'Edit Minuman' : 'Edit Layanan' }}
    </h4>
        ...
        <div class="card-body">
            ...
            <form action="{{ route('produk.update', $produk->id) }}" method="POST">
                ...
                <a href="{{ route('produk.index', [
                        'kategori' => strtolower($produk->kategori) === 'layanan' ? 'layanan' : 'stok',
                        'sub'      => strtolower($produk->kategori) === 'minuman' ? 'minuman' : null
                    ]) }}"
